...
Report bugs at https://github.com/nholuongut/pipreqs/issues.
...
The best way to send feedback is to file an issue at https://github.com/nholuongut/pipreqs/issues.
...
3. The pull request should work for Python 2.7, 3.4, 3.5, 3.6, and PyPy. Check
   https://travis-ci.org/nholuongut/pipreqs/pull_requests and make sure that the
